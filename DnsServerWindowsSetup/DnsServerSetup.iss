...
#define MyAppName "Web 7.0 DID Registry"
#define MyAppVersion "11.1.1"
#define MyAppPublisher "Web 7.0 Foundation"
...
VersionInfoCopyright="Copyright (C) 2023 Technitium. Portions Copyright (C) 2023 Web 7.0 Foundation"
...
[Run]
Filename: "{app}\{#MyAppExeName}"; Parameters: "--first-run"; Description: "{cm:LaunchProgram,{#StringChange("Web 7.0 DID Registry App", '&', '&&')}}"; Flags: nowait postinstall skipifsilent runascurrentuser
